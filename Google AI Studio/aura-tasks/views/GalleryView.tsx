...
import { loadGoogleScripts, handleAuthClick, listDriveFiles, mapMimeTypeToAuraType, hasClientId } from '../utils/googleDrive';
...
const GalleryView: React.FC<GalleryViewProps> = ({ files, setFiles }) => {
  ...
  const connectDrive = () => {
    if (!hasClientId()) {
        alert("Falta configuración: Debes añadir tu GOOGLE_CLIENT_ID en el código (utils/googleDrive.ts) o en las variables de entorno para usar la API real.");
        return;
    }
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        {activeSource === 'google_drive' && !isDriveConnected ? (
           <div className="flex-1 flex flex-col items-center justify-center p-8 text-center animate-fade-in-up">
              ...
              {!hasClientId() && (
                  <div className="bg-orange-50 text-orange-800 text-xs p-4 rounded-xl max-w-md text-left mb-6 border border-orange-200">
                      <strong>Cómo configurar:</strong>
                      <ol className="list-decimal ml-4 mt-2 space-y-1">
                          <li>Crea un proyecto en <a href="https://console.cloud.google.com" target="_blank" className="underline">Google Cloud Console</a>.</li>
                          <li>Habilita la <strong>Google Drive API</strong>.</li>
                          <li>Crea credenciales OAuth 2.0 y obtén el <strong>Client ID</strong>.</li>
                          <li>Pégalo en <code>utils/googleDrive.ts</code>.</li>
                      </ol>
                  </div>
              )}
              ...
              >
                <img src="https://upload.wikimedia.org/wikipedia/commons/1/12/Google_Drive_icon_%282020%29.svg" className="w-5 h-5 bg-white rounded-full p-0.5" />
